/*  =========================================================================
    nmaya_selftest.c - run selftests
...
// Tests for draft public classes:
    { "nmaya", nmaya_test },
    { "nmaya_arrangement", nmaya_arrangement_test },
#endif // NMAYA_BUILD_DRAFT_API
#ifdef NMAYA_BUILD_DRAFT_API
    { "private_classes", nmaya_private_selftest },
#endif // NMAYA_BUILD_DRAFT_API
    {0, 0}          //  Sentinel
};
...
{
    test_item_t *item;
    printf ("Running nmaya selftests...\n");
    for (item = all_tests; item->test; item++)
        item->test (verbose);
